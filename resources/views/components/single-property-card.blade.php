<div class="{{$width}} px-2  relative rounded-md mb-6">
    <div class="shadow-lg">
        ...
        <div class="py-20 flex-1 bg-center" style="background-image: url('{{ asset("storage/uploads/{$property->featured_image}") }}')"></div>
    @else
    <div class="py-20 flex-1 bg-center" style="background-image: url('{{ asset("storage/app/public/uploads{$property->featured_image}") }}')"></div>
